...
def makeplot():
    ...
    plt.title("Could it be, the stupidest plot ever? Probably not.")
    plt.xlabel('Right ascension of system in degrees')
    plt.ylabel('Planet Semi-Major axis (AU)')
